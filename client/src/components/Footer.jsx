        ...
        <footer className="bg-[#B6C9C9] mt-[60px]">
            <div className="flex justify-between footerSection" >
                ...
                <div className=" flex flex-col gap-3 sm:gap-10 contactDetails">
                    <div className="flex gap-3">
                        ...
                        <div >
                            <span className="font-thin text-sm sm:font-normal">+1 236 972 8267</span>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        <div>
                        ...
                        <div>
                            ...
                            <span className="font-thin text-sm sm:font-normal">147 Wyndham St N Guelph, Ontario N1H 5F9</span>
                        </div>
                    </div>
                    <div className="flex gap-3">
                        <div>
            ...
            <div className="flex justify-center">
                <div className="mx-auto">
                    ...
                    <span className="font-thin text-sm sm:font-normal">&#169; 2024 BC RESIDE</span>
                </div>
                <div className="mx-auto">
